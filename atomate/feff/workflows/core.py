...
def get_wf_eels(absorbing_atom, structure=None, feff_input_set="pymatgen.io.feff.sets.MPELNESSet",
                ...
                db_file=None, metadata=None, use_primitive=False, add_xas=None):
    """
    ...
    Args:
        ...
        use_primitive (bool): convert the structure to primitive form. This helps to
            ...
            specified by its atomic symbol.
        add_xas (str): "XANES" or "EXAFS", if not None then XAS fireworks will be appended to
            the EELS fw. Note: make sure you are appending the appropriate XAS type i.e XANES with
            ELNES and EXAFS with EXELFS.
